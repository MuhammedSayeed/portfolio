...
const Navbar = () => {
    ...
    return (
        <nav className="py-9 px-6 md:px-16 flex items-start xl:items-center justify-between fixed z-50 top-0 bg-transparent left-0 right-0 text-white mix-blend-difference">
            <Logo />
